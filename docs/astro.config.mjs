				...
				},
			{
				...
				},
				{
					...
					items: [
						...
						{ label: 'Modules & Imports', slug: 'rfcs/full/modules' },
						{ label: 'Compilation Model', slug: 'rfcs/full/compilation' },
						{ label: 'Runtime JIT Evaluation', slug: 'rfcs/full/runtime-jit-eval' },
						{ label: 'Dynamic Dispatch', slug: 'rfcs/full/dynamic-dispatch' },
						{ label: 'BigInt Promotion', slug: 'rfcs/full/bigint' },
						{ label: 'Lazy Lists', slug: 'rfcs/full/lazy-lists' },
						{ label: 'Unicode Identifiers', slug: 'rfcs/full/unicode-identifiers' },
						{ label: 'Rust FFI', slug: 'rfcs/full/rust-ffi' },
					],
				},
			],
		}),
