---
title: "RFC: Transparent BigInt Promotion"
description: Design for transparent promotion of Int to arbitrary-precision integers via a tagged representation.
---

*Implementation state: see [Implementation Status](/reference/status/)* · tracked in [#35](https://github.com/brianp/asterc/issues/35)
