---
title: "RFC 0001: Unicode Identifier Support"
description: Design for UAX #31 Unicode identifiers with NFC normalization in the Aster lexer.
---

*Implementation state: see [Implementation Status](/reference/status/)* · tracked in [#39](https://github.com/brianp/asterc/issues/39)
