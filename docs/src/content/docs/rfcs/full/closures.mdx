---
title: "Full RFC: Closure Capture Semantics"
description: The complete closure capture semantics RFC for Aster.
sidebar:
  badge:
    text: Decided
    variant: success
...
copies (async boundary) of captured variables.
...
2. **Capture syntax?** None. Capture is implicit.
