...
#[test]
fn e2e_string_trim() {
    let dir = common::make_temp_dir("str-trim");
...
fn e2e_string_to_upper() {
    let dir = common::make_temp_dir("str-upper");
...
fn e2e_string_to_lower() {
    let dir = common::make_temp_dir("str-lower");
...
fn e2e_string_contains() {
    let dir = common::make_temp_dir("str-contains");
...
fn e2e_string_starts_with() {
    let dir = common::make_temp_dir("str-sw");
...
fn e2e_string_ends_with() {
    let dir = common::make_temp_dir("str-ew");
...
fn e2e_string_replace() {
    let dir = common::make_temp_dir("str-replace");
...
#[test]
fn e2e_string_slice() {
    let dir = common::make_temp_dir("str-slice");
...
#[test]
fn e2e_string_split() {
    let dir = common::make_temp_dir("str-split");
...
fn e2e_string_split_len() {
    let dir = common::make_temp_dir("str-split-len");
...
fn e2e_string_len_unicode() {
    let dir = common::make_temp_dir("str-len-uni");
