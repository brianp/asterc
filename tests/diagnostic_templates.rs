...
fn template_enum_wraps_module_errors() {
    ...
    let t = DiagnosticTemplate::ModuleNotFound(ModuleNotFound {
        name: "foo".into(),
    });
...
fn template_enum_wraps_warnings() {
    ...
    let t = DiagnosticTemplate::ShadowedVariable(ShadowedVariable {
        name: "x".into(),
    });
...
fn type_mismatch_code_is_e001() {
    use ast::templates::type_errors::TypeMismatch;
    let t = TypeMismatch { expected: ast::Type::Int, actual: ast::Type::String };
...
fn unexpected_token_code_is_p001() {
    use ast::templates::parse_errors::UnexpectedToken;
    let t = UnexpectedToken { expected: "identifier".into(), found: ")".into() };
...
fn type_mismatch_render_contains_both_types() {
    ...
    let t = TypeMismatch { expected: ast::Type::Int, actual: ast::Type::String };
    let msg = t.render();
    assert!(msg.contains("Int"), "render should mention expected type: {}", msg);
    assert!(msg.contains("String"), "render should mention actual type: {}", msg);
}

#[test]
fn undefined_variable_render_contains_name() {
    use ast::templates::type_errors::UndefinedVariable;
    let t = UndefinedVariable { name: "my_var".into() };
    let msg = t.render();
    assert!(msg.contains("my_var"), "render should mention the variable name: {}", msg);
}
...
fn unexpected_token_render_contains_expected_and_found() {
    ...
    let t = UnexpectedToken { expected: "identifier".into(), found: ")".into() };
    let msg = t.render();
    assert!(msg.contains("identifier"), "render should mention expected: {}", msg);
...
fn template_serializes_to_json_with_variant_name() {
    ...
    assert!(json.contains("TypeMismatch"), "JSON should contain variant name: {}", json);
}
...
fn diagnostic_with_template_serializes_template_field() {
    ...
    assert!(json.contains("TypeMismatch"), "serialized diagnostic should include template: {}", json);
}
...
fn all_type_error_codes_have_variants() {
    ...
    let _variants: Vec<DiagnosticTemplate> = vec![
        DiagnosticTemplate::TypeMismatch(TypeMismatch { expected: ast::Type::Int, actual: ast::Type::String }),
        DiagnosticTemplate::UndefinedVariable(UndefinedVariable { name: "".into() }),
        DiagnosticTemplate::BinaryOpError(BinaryOpError { op: "".into(), left: ast::Type::Int, right: ast::Type::String }),
        DiagnosticTemplate::ReturnTypeMismatch(ReturnTypeMismatch { function: "".into(), expected: ast::Type::Int, actual: ast::Type::String }),
        DiagnosticTemplate::ArgumentTypeMismatch(ArgumentTypeMismatch { param: "".into(), expected: ast::Type::Int, actual: ast::Type::String }),
        DiagnosticTemplate::ArgumentCountMismatch(ArgumentCountMismatch { expected: 0, actual: 0 }),
        DiagnosticTemplate::UnknownField(UnknownField { field: "".into(), type_name: "".into() }),
    ];
}
...
fn all_parse_error_codes_have_variants() {
    ...
    let _variants: Vec<DiagnosticTemplate> = vec![
        DiagnosticTemplate::UnexpectedToken(UnexpectedToken { expected: "".into(), found: "".into() }),
...
fn all_module_error_codes_have_variants() {
    ...
    let _variants: Vec<DiagnosticTemplate> = vec![
        ...
        DiagnosticTemplate::SymbolNotExported(SymbolNotExported { symbol: "".into(), module: "".into() }),
...
fn all_template_codes_are_unique() {
    ...
    let templates: Vec<DiagnosticTemplate> = vec![
        DiagnosticTemplate::TypeMismatch(TypeMismatch { expected: ast::Type::Int, actual: ast::Type::Int }),
        DiagnosticTemplate::UndefinedVariable(UndefinedVariable { name: "".into() }),
        DiagnosticTemplate::BinaryOpError(BinaryOpError { op: "".into(), left: ast::Type::Int, right: ast::Type::Int }),
        DiagnosticTemplate::ReturnTypeMismatch(ReturnTypeMismatch { function: "".into(), expected: ast::Type::Int, actual: ast::Type::Int }),
        DiagnosticTemplate::ArgumentTypeMismatch(ArgumentTypeMismatch { param: "".into(), expected: ast::Type::Int, actual: ast::Type::Int }),
        DiagnosticTemplate::ArgumentCountMismatch(ArgumentCountMismatch { expected: 0, actual: 0 }),
        DiagnosticTemplate::MissingIterable(MissingIterable { type_name: "".into() }),
        ...
        DiagnosticTemplate::ConditionTypeError(ConditionTypeError { actual: ast::Type::Int }),
        DiagnosticTemplate::IndexTypeError(IndexTypeError { actual: ast::Type::Int }),
        DiagnosticTemplate::InconsistentListType(InconsistentListType { expected: ast::Type::Int, actual: ast::Type::Int }),
        DiagnosticTemplate::UnaryOpError(UnaryOpError { op: "".into(), actual: ast::Type::Int }),
        ...
        DiagnosticTemplate::CollectionConstraintError(CollectionConstraintError { message: "".into() }),
        ...
        DiagnosticTemplate::CircularImport(CircularImport { module: "".into() }),
        DiagnosticTemplate::InvalidImportAlias(InvalidImportAlias),
        DiagnosticTemplate::RedundantTypeAnnotation(RedundantTypeAnnotation { type_name: "".into() }),
        ...
        DiagnosticTemplate::InvalidEscape(InvalidEscape { sequence: "".into() }),
