...
fn drop_called_on_scope_exit() {
    let dir = crate::common::make_temp_dir("drop-scope-exit");
...
fn drop_reverse_order() {
    let dir = crate::common::make_temp_dir("drop-reverse-order");
...
fn drop_called_on_explicit_return() {
    let dir = crate::common::make_temp_dir("drop-explicit-return");
...
fn drop_called_on_break() {
    let dir = crate::common::make_temp_dir("drop-break");
...
fn drop_called_on_continue() {
    let dir = crate::common::make_temp_dir("drop-continue");
...
fn drop_called_on_void_function_end() {
    let dir = crate::common::make_temp_dir("drop-void-end");
...
fn drop_on_break_only_cleans_loop_locals() {
    let dir = crate::common::make_temp_dir("drop-break-scope");
