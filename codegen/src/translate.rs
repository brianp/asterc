...
fn translate_expr(
    ...
    match expr {
        ...
        FirExpr::EvalCall {
            ...
            // Always use aster_runtime_eval_with_ctx for evaluate() calls so
            // errors are surfaced via the typed error flag (EvalError). Pass
            // null env_ptr when no captures exist.
